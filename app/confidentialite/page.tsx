      ...
      <main className="min-h-screen bg-[#070014] text-white px-6 py-16 max-w-4xl mx-auto">
        ...
        <section className="mb-10">
          ...
          <div className="bg-white/5 border border-white/10 rounded-xl p-6 space-y-2 text-gray-300 text-sm">
            ...
            <p><span className="text-white font-medium">Adresse :</span> 935 Route de la Vy de l'Eau, 74140 Saint-Cergues</p>
        ...
        <section className="mb-10">
          ...
          <p className="text-gray-400 text-xs italic">
            Note : les outils IA présentés dans la formation (Claude, ChatGPT, etc.) sont soumis aux politiques de leurs propres éditeurs. Nadia Farfar n'a aucun accès aux données que tu leur transmets.
          </p>
        </section>
        ...
        <section className="mb-10">
          ...
          <p className="text-gray-300 text-sm mb-2">Pour exercer ces droits : <span className="text-violet-300">lisaformationia@gmail.com</span></p>
